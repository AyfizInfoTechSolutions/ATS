...
const servicesData = [
  {
    ...
    short:
      "Comprehensive support in import/export, logistics, compliance, and market entry.",
    ...
    extra:
      "They optimize logistics through efficient transportation management, supply chain coordination, and warehousing solutions, ensuring timely delivery across borders. Experts help businesses adhere to local laws, leverage trade agreements, and mitigate risks related to sanctions or trade restrictions.",
  ...
  },
  {
    ...
    short:
      "Intermediary for buying and selling assets like stocks, commodities, and currencies.",
    ...
    extra:
      "Brokers offer advisory services, market insights, and trading support to help clients make informed decisions while ensuring compliance with local regulations. They assist in managing currency risks through hedging strategies and ensure accurate clearing and settlement.",
  ...
  },
  {
    ...
    short:
      "Market insights, tailored entry strategies, and regulatory compliance support.",
    ...
    extra:
      "Consultants craft market entry strategies, such as partnerships or wholly-owned subsidiaries, and develop distribution plans. They ensure compliance with local laws, trade regulations, and taxes while providing guidance on workforce localization and supply chain management.",
  ...
  },
  {
    ...
    short:
      "Identifying and securing reliable suppliers to optimize your procurement chain.",
    ...
    extra:
      "These services optimize supply chains, reduce costs, and improve efficiency. With expertise in global markets, sourcing services enable businesses to access the best resources worldwide while managing vendor relationships and mitigating risks.",
  ...
  },
  {
    ...
    short:
      "Efficient storage and strategic movement for timely global delivery.",
    ...
    extra:
      "These services ensure goods are organized, accessible, and ready for dispatch. Distribution involves coordinating transportation and logistics to meet delivery schedules, enhancing customer satisfaction and operational efficiency.",
      ...
      <div className="bg-brand-dark py-16 text-white border-t border-gray-800">
        <div className="max-w-8xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-12">
          {[
            ...
            <div
              key={item.label}
              className="border-l border-brand-primary/30 pl-6"
            >
